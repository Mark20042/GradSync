...
const EmployerMessages = () => {
  ...
  // Handle navigation from Applicant Profile
  useEffect(() => {
    if (location.state?.conversationId && location.state?.jobId && conversations.length > 0) {
      const { conversationId, jobId } = location.state;
