      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute bottom-full mb-2 ${alignRight ? "right-0" : "left-0"} w-72 bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 z-[100] p-2 overflow-hidden ring-1 ring-black/5`}
          >
            {children}
          </motion.div>
        )}
