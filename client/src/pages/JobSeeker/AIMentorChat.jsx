...
const AIMentorChat = () => {
  ...
  return (
    <div className="h-screen bg-[#F8FAFC] flex flex-col overflow-hidden">
      ...
      {/* Main Chat Container */}
      <div className="flex-1 pt-24 px-4 pb-6 max-w-5xl mx-auto w-full flex flex-col min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gradient-to-b from-gray-50/50 to-white">
            <AnimatePresence initial={false}>
              {messages.map((msg) => (
                ...
                >
                  <div
                    className={`flex items-end gap-3 max-w-[85%] ${msg.sender === "user" ? "flex-row-reverse" : "flex-row"}`}
                  >
                    {/* Avatar */}
                    <div
          ...
          <div className="p-6 bg-white border-t border-gray-100">
            ...
            >
              <button
                type="button"
                onClick={fetchJobs}
                className={`px-4 py-3.5 rounded-xl transition-all duration-200 flex-shrink-0 flex items-center gap-2 ${
                  selectedJob
