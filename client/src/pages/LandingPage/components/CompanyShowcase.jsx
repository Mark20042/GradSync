      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
          {companies.map((company) => (
            <div
              key={company._id}
              className="flex flex-col items-center justify-center  hover:grayscale-0 transition-all duration-300  hover:opacity-100"
            >
              {company.companyLogo ? (
                <img
              ...
              >
                <span className="font-bold text-xl md:text-2xl text-gray-700">
                  {company.companyName}
                </span>
              </div>
            </div>
