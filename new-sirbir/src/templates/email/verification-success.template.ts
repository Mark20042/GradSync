export const getVerificationSuccessEmailTemplate = (
  ...
  const features = isEmployer
    ? [
        { icon: "💼", title: "Post Job Openings", desc: "Create and manage job listings to attract top talent" },
        { icon: "📋", title: "Manage Applications", desc: "Review and track candidate applications efficiently" },
        { icon: "👥", title: "Connect with Candidates", desc: "Communicate directly with qualified applicants" },
      ]
    : [
        { icon: "🔍", title: "Browse & Apply for Jobs", desc: "Discover opportunities that match your skills" },
        { icon: "📄", title: "Build Your Resume", desc: "Create a professional profile that stands out" },
        { icon: "🤖", title: "AI Career Mentoring", desc: "Get personalized guidance for your career path" },
        { icon: "✅", title: "Skill Assessments", desc: "Validate your expertise with interactive tests" },
      ];
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td width="48" style="vertical-align: top; padding-right: 16px;">
              <div style="width: 48px; height: 48px; background: linear-gradient(135deg, #10B981 0%, #059669 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 24px; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.2);">${f.icon}</div>
            </td>
  ...
  return `
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            @media only screen and (max-width: 600px) {
                ...
                .mobile-feature-title { font-size: 15px !important; }
                .mobile-feature-desc { font-size: 13px !important; }
    ...
    <body style="margin: 0; padding: 0; background-color: #F3F4F6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; width: 100%;">
        ...
        <div style="display: none; max-height: 0; overflow: hidden; mso-hide: all;">
            Your ${docType} has been verified! Welcome to GradSync - start exploring opportunities now.
        </div>
            ...
            <tr>
                <td align="center" style="padding: 20px 10px;">
                    <table class="email-container" width="600" cellpadding="0" cellspacing="0" border="0" role="presentation" style="background-color: #FFFFFF; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden; max-width: 600px; width: 100%;">
                        ...
                        <tr>
                            <td class="mobile-padding" style="background: linear-gradient(135deg, #10B981 0%, #059669 100%); padding: 48px 40px; text-align: center;">
                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td align="center">
                        ...
                        <tr>
                            <td class="mobile-padding" style="padding: 40px;">
                                ...
                                <!-- Features Section -->
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="background: linear-gradient(135deg, #ECFDF5 0%, #D1FAE5 100%); border-radius: 12px; margin-bottom: 32px; overflow: hidden;">
                                    <tr>
                                        <td class="mobile-padding-small" style="padding: 24px;">
                                            <h2 style="margin: 0 0 20px; font-size: 18px; font-weight: 700; color: #065F46; line-height: 1.3;">
                                                🎉 What you can do now:
                                            </h2>
                                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                ${featureRows}
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
                                    <tr>
                                        <td align="center" style="padding: 8px 0 32px;">
                                            <!--[if mso]>
                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${dashboardUrl}" style="height:52px;v-text-anchor:middle;width:200px;" arcsize="23%" stroke="f" fillcolor="#10B981">
                                                <w:anchorlock/>
                                                <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:600;">Get Started →</center>
                                            </v:roundrect>
                                            <![endif]-->
                                            <!--[if !mso]><!-->
                                            <a href="${dashboardUrl}" class="mobile-button" style="display: inline-block; background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: #FFFFFF; text-decoration: none; padding: 16px 48px; border-radius: 12px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3); line-height: 1.5;">
                                                Get Started →
                                            </a>
                                            <!--<![endif]-->
                                        </td>
