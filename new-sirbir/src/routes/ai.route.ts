...
import { checkSuitability, generateSummary, scanForMatches, checkCandidateSuitability, askMentor } from "@/controllers/ai.controller.js";
...
router.post("/mentor", authenticationMiddleware, askMentor as any);
