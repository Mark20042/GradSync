...
router.put("/:assessmentId/questions/:questionId", authenticationMiddleware, ctrl.updateQuestion);
router.delete("/:assessmentId/questions/:questionId", authenticationMiddleware, ctrl.deleteQuestion);
router.get("/:skill/users", authenticationMiddleware, ctrl.getVerifiedUsers);
router.delete("/:skill/users/:userId", authenticationMiddleware, ctrl.unverifyUser);
